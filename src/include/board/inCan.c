...
#if defined(__BOARD_inCan_DS) || defined(__BOARD_inCan_DHT11) || \
...
#elif defined(__BOARD_inCanRS_DS) || defined(__BOARD_inCanRS_DHT11) || \
...
void ICACHE_FLASH_ATTR supla_esp_board_set_channels(
  ...
  *channel_count = 3;
  ...
  if (supla_input_cfg[0].type == INPUT_TYPE_BTN_MONOSTABLE) {
    channels[2].FuncList =
        SUPLA_BIT_RELAYFUNC_LIGHTSWITCH | SUPLA_BIT_RELAYFUNC_POWERSWITCH;
  } else {
