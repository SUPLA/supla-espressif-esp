...
const char supla_esp_cfgmode_html_header[] ICACHE_RODATA_ATTR =
    ...
    "pointer-events:none;font-size:min(10px, 1vw)}input,select{width:calc(100% "
    ...
    "none}</style><script>function protocolChanged(){var "
    "e=document.getElementById(\"protocol\"),t=document.getElementById(\"proto_"
    "supla\"),n=document.getElementsByClassName(\"mqtt\"),l=\"1\"==e.value?"
    "\"block\":\"none\";for(i=0;i<n.length;i++)n[i].style.display=l;t.style."
    "display=\"1\"==e.value?\"none\":\"block\"}function mAuthChanged(){var "
    "e=document.getElementById(\"sel_mauth\"),t=document.getElementById("
    "\"mauth_usr\"),n=document.getElementById(\"mauth_pwd\"),e=\"1\"==e.value?"
    "\"block\":\"none\";t.style.display=e,n.style.display=e}function "
    "saveAndReboot(){var "
    "e=document.getElementById(\"cfgform\");e.rbt.value=\"2\",e.submit()}"
    "setTimeout(function(){var "
    "e=document.getElementById(\"msg\");null!=e&&(e.style.visibility="
    "\"hidden\")},3200);</script><body "
...
const char supla_esp_cfgmode_html_main[] ICACHE_RODATA_ATTR =
    ...
    "class=\"w mqtt\"><h3>MQTT Settings</h3><i><input "
    ...
    "maxlength=\"80\"><label>Username</label></i><i id=\"mauth_pwd\"><input "
    "name=\"mwd\" maxlength=\"205\" type=\"password\"><label>Password "
    "(Required. Max 200)</label></i><i><input name=\"pfx\" "
